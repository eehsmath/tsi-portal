...
(function () {
  ...
  var REGISTRY = [
    ...
    { sec: 'alg', id: 'AR.1', code: 'AR.1', short: 'Linear equations & systems', onCRC: true, status: 'ready',
    ...
    { sec: 'alg', id: 'AR.2', code: 'AR.2', short: 'Linear functions', onCRC: true, status: 'ready',
    ...
    { sec: 'alg', id: 'AR.3', code: 'AR.3', short: 'Quadratic & exponential growth', onCRC: true, status: 'ready',
    ...
    { sec: 'alg', id: 'AR.4', code: 'AR.4', short: 'Polynomial & rational expressions', onCRC: true, status: 'ready',
    ...
    { sec: 'alg', id: 'AR.5', code: 'AR.5', short: 'Solving advanced equations', onCRC: true, status: 'ready',
    ...
    { sec: 'quant', id: 'QR.1', code: 'QR.1', short: 'Basic operations', onCRC: false, status: 'ready',
    ...
    { sec: 'quant', id: 'QR.2', code: 'QR.2', short: 'Rounding numbers', onCRC: false, status: 'ready',
      name: 'Round numbers to a given decimal place.',
      reuse: null, file: 'apps/tsi-qr.html', modules: ['QR.2'] },
    { sec: 'quant', id: 'QR.3', code: 'QR.3', short: 'Comparing numbers', onCRC: false, status: 'ready',
    ...
    { sec: 'quant', id: 'QR.4', code: 'QR.4', short: 'Rational vs. irrational', onCRC: true, status: 'ready',
      name: 'Compare magnitudes of rational and irrational numbers.',
      reuse: null, file: 'apps/tsi-qr.html', modules: ['QR.4'] },
    { sec: 'quant', id: 'QR.5', code: 'QR.5', short: 'Ratios, proportions & percents', onCRC: true, status: 'ready',
    ...
    { sec: 'quant', id: 'QR.6', code: 'QR.6', short: 'Proportional relationships', onCRC: true, status: 'ready',
    ...
    { sec: 'quant', id: 'QR.7', code: 'QR.7', short: 'Linear expressions', onCRC: true, status: 'ready',
    ...
    { sec: 'geo', id: 'GSR.1', code: 'GSR.1', short: 'Units of measurement', onCRC: false, status: 'ready',
      name: 'Identify common units of measurement.', reuse: null, file: 'apps/tsi-gsr.html', modules: ['GSR.1'] },
    { sec: 'geo', id: 'GSR.2', code: 'GSR.2', short: 'Types of angles', onCRC: false, status: 'ready',
      name: 'Identify and define types of angles.', reuse: null, file: 'apps/tsi-gsr.html', modules: ['GSR.2'] },
    { sec: 'geo', id: 'GSR.3', code: 'GSR.3', short: 'Unit conversions', onCRC: true, status: 'ready',
      name: 'Convert units within systems of measurement.', reuse: null, file: 'apps/tsi-gsr.html', modules: ['GSR.3'] },
    { sec: 'geo', id: 'GSR.4', code: 'GSR.4', short: 'Perimeter, area & volume', onCRC: true, status: 'ready',
    ...
    { sec: 'geo', id: 'GSR.5', code: 'GSR.5', short: 'Transformations & symmetry', onCRC: true, status: 'ready',
    ...
    { sec: 'geo', id: 'GSR.6', code: 'GSR.6', short: 'Right triangles & trig', onCRC: true, status: 'ready',
      name: 'Apply right triangle relationships and basic trigonometry.', reuse: null, file: 'apps/tsi-gsr.html', modules: ['GSR.6'] },
    { sec: 'geo', id: 'GSR.7', code: 'GSR.7', short: 'Geometry meets algebra', onCRC: true, status: 'ready',
    ...
    { sec: 'prob', id: 'PSR.1', code: 'PSR.1', short: 'Sorting & counting data', onCRC: false, status: 'ready',
      name: 'Sort and count data.', reuse: null, file: 'apps/tsi-psr.html', modules: ['PSR.1'] },
    { sec: 'prob', id: 'PSR.2', code: 'PSR.2', short: 'Graphs & tables', onCRC: false, status: 'ready',
    ...
    { sec: 'prob', id: 'PSR.3', code: 'PSR.3', short: 'Probability', onCRC: true, status: 'ready',
      name: 'Compute and interpret probability.', reuse: null, file: 'apps/tsi-psr.html', modules: ['PSR.3'] },
    { sec: 'prob', id: 'PSR.4', code: 'PSR.4', short: 'Mean, median & spread', onCRC: true, status: 'ready',
      name: 'Compute and describe measures of center and spread of data.', reuse: null, file: 'apps/tsi-psr.html', modules: ['PSR.4'] },
    { sec: 'prob', id: 'PSR.5', code: 'PSR.5', short: 'Choosing data displays', onCRC: true, status: 'ready',
    ...
    { sec: 'prob', id: 'PSR.6', code: 'PSR.6', short: 'Drawing conclusions from data', onCRC: true, status: 'ready',
