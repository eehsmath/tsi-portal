...
(function () {
  ...
  var REGISTRY = [
    ...
    { sec: 'alg', id: 'AR.2', code: 'AR.2', onCRC: true, status: 'soon',
      ...
      reuse: 'apps/teks-a3.html + apps/teks-a12.html (A.12B)', file: 'apps/tsi-ar.html', modules: ['AR.2'] },
    { sec: 'alg', id: 'AR.3', code: 'AR.3', onCRC: true, status: 'soon',
      ...
      reuse: 'apps/teks-a6/7/8.html + apps/teks-a9.html', file: 'apps/tsi-ar.html', modules: ['AR.3'] },
    { sec: 'alg', id: 'AR.4', code: 'AR.4', onCRC: true, status: 'soon',
      name: 'Identify and manipulate quadratic, polynomial, exponential, rational, and radical equations and expressions.',
      reuse: 'apps/teks-a6/9/10/11.html \u2014 rational expressions are new (Alg II TEKS)', file: 'apps/tsi-ar.html', modules: ['AR.4'] },
    { sec: 'alg', id: 'AR.5', code: 'AR.5', onCRC: true, status: 'soon',
      name: 'Solve equations and evaluate functions (e.g., quadratic, polynomial, exponential, rational, and radical).',
      reuse: 'apps/teks-a7/8/9/12.html \u2014 solving rational equations is new (Alg II TEKS)', file: 'apps/tsi-ar.html', modules: ['AR.5'] },

    /* --- Quantitative Reasoning (QR) --- */
    { sec: 'quant', id: 'QR.1', code: 'QR.1', onCRC: false, status: 'soon',
    ...
    { sec: 'quant', id: 'QR.2', code: 'QR.2', onCRC: false, status: 'soon',
      name: 'Round numbers to a given decimal place.',
      reuse: null, file: 'apps/tsi-qr.html', modules: ['QR.2'] },
    { sec: 'quant', id: 'QR.3', code: 'QR.3', onCRC: false, status: 'soon',
    ...
    { sec: 'quant', id: 'QR.6', code: 'QR.6', onCRC: true, status: 'soon',
    ...
    { sec: 'quant', id: 'QR.7', code: 'QR.7', onCRC: true, status: 'soon',
